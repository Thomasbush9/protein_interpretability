"""`pi_stats` now lives at `protein_interpretability.analysis.statistics`.

This is an alias, not a copy. It keeps the ~60 scripts in this directory
importing `pi_stats` unchanged while the package becomes the real home, so the
...
import protein_interpretability.analysis.statistics as _module  # noqa: E402
