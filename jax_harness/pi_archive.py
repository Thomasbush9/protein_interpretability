"""`pi_archive` now lives at `protein_interpretability.artifacts`.

This is an alias, not a copy. It keeps the ~60 scripts in this directory
importing `pi_archive` unchanged while the package becomes the real home, so the
...
import protein_interpretability.artifacts as _module  # noqa: E402
