"""`pi_chem` now lives at `protein_interpretability.analysis.chemistry`.

This is an alias, not a copy. It keeps the ~60 scripts in this directory
importing `pi_chem` unchanged while the package becomes the real home, so the
...
import protein_interpretability.analysis.chemistry as _module  # noqa: E402
