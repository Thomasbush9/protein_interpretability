"""`pi_metrics` now lives at `protein_interpretability.analysis.metrics`.

This is an alias, not a copy. It keeps the ~60 scripts in this directory
importing `pi_metrics` unchanged while the package becomes the real home, so the
...
import protein_interpretability.analysis.metrics as _module  # noqa: E402
