"""`pi_basis` now lives at `protein_interpretability.analysis.basis`.

This is an alias, not a copy. It keeps the ~60 scripts in this directory
importing `pi_basis` unchanged while the package becomes the real home, so the
...
import protein_interpretability.analysis.basis as _module  # noqa: E402
